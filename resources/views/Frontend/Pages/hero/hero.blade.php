 <section class="hero-bg min-h-screen flex items-center justify-center text-white text-center px-4"
        style="background: linear-gradient(135deg, rgba(0, 73, 44, 0.8), rgba(0, 0, 0, 0.6)), url('/image/gedung-unujogja.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
