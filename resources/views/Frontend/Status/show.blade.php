                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            @if($report->client->sumber_informasi ?? null)
                            <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-col sm:flex-row">
                                ...
                                <span class="flex-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">
                                    @if($report->reporter->tanggal_lahir ?? null)
                            ...
                            @if($report->reporter->keterangan_tambahan ?? null)
                            <div class="flex flex-col sm:flex-row">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-col sm:flex-row">
                                ...
                                <span class="flex-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">
                                    @if($report->violance->waktu_kejadian ?? null)
