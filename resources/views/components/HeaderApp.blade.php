    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
        <div class="flex items-center justify-between h-14 sm:h-16 md:h-18 lg:h-20">
            ...
            <div class="hidden lg:flex items-center space-x-1 xl:space-x-2">
                <a href="{{ route('home') }}" class="flex items-center space-x-1.5 xl:space-x-2 px-2.5 xl:px-4 py-2 rounded-lg text-white text-sm font-medium transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5 border border-transparent hover:border-yellow-300 hover:border-opacity-30" aria-label="Beranda">
                    <i class="fas fa-home text-yellow-300 text-sm" aria-hidden="true"></i>
                    <span class="whitespace-nowrap">Beranda</span>
                </a>
                <a href="{{ route('lapor-kekerasan.create') }}" class="flex items-center space-x-1.5 xl:space-x-2 px-2.5 xl:px-4 py-2 rounded-lg text-white text-sm font-medium transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5 border border-transparent hover:border-yellow-300 hover:border-opacity-30" aria-label="Lapor Kasus">
                    <i class="fas fa-exclamation-triangle text-yellow-300 text-sm" aria-hidden="true"></i>
                ...
                <a href="{{ route('edukasi') }}" class="flex items-center space-x-1.5 xl:space-x-2 px-2.5 xl:px-4 py-2 rounded-lg text-white text-sm font-medium transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5 border border-transparent hover:border-yellow-300 hover:border-opacity-30" aria-label="Edukasi">
                    <i class="fas fa-book-open text-yellow-300 text-sm" aria-hidden="true"></i>
                    <span class="whitespace-nowrap">Edukasi</span>
                </a>
                <a href="{{ route('tentang-kami') }}" class="flex items-center space-x-1.5 xl:space-x-2 px-2.5 xl:px-4 py-2 rounded-lg text-white text-sm font-medium transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5 border border-transparent hover:border-yellow-300 hover:border-opacity-30" aria-label="Tentang Kami">
                    <i class="fas fa-info-circle text-yellow-300 text-sm" aria-hidden="true"></i>
            ...
            <div class="hidden md:flex lg:hidden items-center space-x-1">
                <a href="{{ route('home') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5" aria-label="Beranda" title="Beranda">
                    <i class="fas fa-home text-yellow-300" aria-hidden="true"></i>
                </a>
                <a href="{{ route('lapor-kekerasan.create') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5" aria-label="Lapor Kasus" title="Lapor Kasus">
                    <i class="fas fa-exclamation-triangle text-yellow-300" aria-hidden="true"></i>
                </a>
                <a href="{{ route('cek-status') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5 relative" aria-label="Cek Status" title="Cek Status">
                ...
                <a href="{{ route('berita') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5" aria-label="Berita" title="Berita">
                    <i class="fas fa-newspaper text-yellow-300" aria-hidden="true"></i>
                </a>
                <a href="{{ route('edukasi') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5" aria-label="Edukasi" title="Edukasi">
                    <i class="fas fa-book-open text-yellow-300" aria-hidden="true"></i>
                </a>
                <a href="{{ route('tentang-kami') }}" class="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:text-yellow-300 hover:-translate-y-0.5" aria-label="Tentang Kami" title="Tentang Kami">
            ...
            <button 
                id="mobile-menu-btn" 
                class="md:hidden bg-white bg-opacity-10 border border-white border-opacity-20 text-white p-2.5 rounded-lg transition-all duration-300 hover:bg-opacity-20 hover:text-yellow-300 hover:scale-105 glass-effect flex-shrink-0" 
...
>
    ...
    <div class="p-4 sm:p-6 text-center border-b border-white border-opacity-10">
        <div class="w-12 h-12 sm:w-16 sm:h-16 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 glass-effect border border-white border-opacity-20">
            <i class="fas fa-shield-alt text-yellow-300 text-xl sm:text-2xl" aria-hidden="true"></i>
        </div>
        <h2 id="mobile-menu-title" class="text-white text-lg sm:text-xl font-bold mb-1">SATGAS PPKS</h2>
    ...
    <nav class="p-3 sm:p-4" role="navigation" aria-label="Mobile navigation">
        <a href="{{ route('home') }}" class="flex items-center p-3 sm:p-4 mb-1.5 sm:mb-2 rounded-xl text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:translate-x-1 border border-transparent hover:border-yellow-300 hover:border-opacity-30">
        ...
        <a href="{{ route('lapor-kekerasan.create') }}" class="flex items-center p-3 sm:p-4 mb-1.5 sm:mb-2 rounded-xl text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:translate-x-1 border border-transparent hover:border-yellow-300 hover:border-opacity-30">
        ...
        <a href="{{ route('edukasi') }}" class="flex items-center p-3 sm:p-4 mb-1.5 sm:mb-2 rounded-xl text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:translate-x-1 border border-transparent hover:border-yellow-300 hover:border-opacity-30">
        ...
        <a href="{{ route('tentang-kami') }}" class="flex items-center p-3 sm:p-4 mb-1.5 sm:mb-2 rounded-xl text-white transition-all duration-300 hover:bg-white hover:bg-opacity-10 hover:translate-x-1 border border-transparent hover:border-yellow-300 hover:border-opacity-30">
