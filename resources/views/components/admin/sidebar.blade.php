<div class="w-72 bg-white sidebar-shadow flex flex-col transition-all duration-300 ease-in-out border-r border-gray-100 fixed md:static z-30 -translate-x-full md:translate-x-0 sidebar-content" id="sidebar">
    <div class="flex-1 overflow-y-auto smooth-scroll py-6">
        <!-- Enhanced Navigation -->
        <nav class="px-6 space-y-6">
            <!-- Dashboard -->
            <div class="space-y-2">
